...
export const GridScan: React.FC<GridScanProps> = ({
  ...
  useEffect(() => {
    ...
    if (bloomRef.current) {
      ...
      const bloomEffect = bloomRef.current as BloomEffect & {
        luminanceMaterial: { threshold: number; smoothing: number };
      };
      bloomEffect.luminanceMaterial.threshold = bloomThreshold;
      bloomEffect.luminanceMaterial.smoothing = bloomSmoothing;
    }

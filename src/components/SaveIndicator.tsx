...
export default function SaveIndicator({ isSaving, lastSaved, error }: SaveIndicatorProps) {
  if (error) {
    return (
      <div className="flex items-center gap-2 text-xs text-[var(--cc-error)] w-[128px]">
  ...
  if (isSaving) {
    return (
      <div className="flex items-center gap-2 text-xs text-[var(--cc-accent)] w-[128px]">
  ...
  if (lastSaved) {
    return (
      <div className="flex items-center gap-2 text-xs text-[var(--cc-success)] w-[128px]">
        <svg className="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="flex items-center gap-2 text-xs text-[var(--cc-text-secondary)] w-[128px]">
      <svg className="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">

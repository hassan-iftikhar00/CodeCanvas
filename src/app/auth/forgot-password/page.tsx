                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                          <svg
                            className={`h-5 w-5 transition-colors ${emailTouched && emailError ? "text-red-400" : "text-[#666666]"}`}
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                          >
                        ...
                        <input
                          ...
                          className={`block w-full rounded-xl border bg-[#0A0A0A]/50 pl-12 pr-4 py-3.5 text-white placeholder-[#666666] transition-all focus:outline-none focus:ring-2 focus:bg-[#0A0A0A] disabled:opacity-50 disabled:cursor-not-allowed ${
